...
exports.start = function(SETUP) {
  ...
  const UpdateEmbed = function() {
    ...
    .setAuthor("Oceanic Network Server Status", "https://cdn.discordapp.com/attachments/580680574369398794/582249284825776148/logo_vinity_end.png")
    .setColor(0x2894C2)
    .setFooter(TICK_N % 2 === 0 ? '⚪ Oceanic Network' : '⚫ Oceanic Network')
  ...
  bot.on('ready',() => {
    ...
    // bot.user.setGame('Oceanic Network', 'discord.gg/OceanicNetwork');
    bot.user.setActivity('Oceanic Network',{'url':'discord.gg/OceanicNetwork','type':'Watching'});
